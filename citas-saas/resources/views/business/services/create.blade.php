...
@section('content')
    ...
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Nuevo servicio</h2>
        <p class="text-gray-500">Agrega un servicio a tu negocio</p>
    </div>

    <div class="bg-white rounded-xl shadow p-6 max-w-2xl">
        <form method="POST" action="{{ route('business.services.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="Descripción opcional del servicio">{{ old('description') }}</textarea>
            </div>
